                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button data-toggle="modal" data-target="#ubahModal" type="button" class="btn btn-info ubah"
                        data-id_admin="{{$adm->id_admin}}"
                        data-nama_admin="{{$adm->nama_admin}}"
                        data-email_admin="{{$adm->email_admin}}"
                        data-alamat_admin="{{$adm->alamat_admin}}"
                        >
                          <i class='fas fa-edit'></i>Ubah</button>
                          <a class="konfirmasi" href="/hapusHapis/{{$adm->id_admin}}"><button type="button" class="btn btn-danger"><i class='fas fa-trash'></i>Hapus
                          </button></a>
...
<script>
  ...
  $(document).on("click",".ubah",function(){
    ...
    var email = $(this).data('email_admin');
    var alamat = $(this).data('alamat_admin');
  ...
  $(document).on("click",".konfirmasi",function(event){
    ...
    var answer = window.confirm("Kamu yakin akan menghapus data Admin?");
    if(answer){
