...
<head>
  ...
  <title>Home - Pengadaan App</title>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Ketentuan</h2>
          <p>Untuk dapat mengajukan pengajuan barang dan jasa, Peserta harus memenuhi kualifikasi berikut ini :</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Memiliki Izin Usaha yang resmi dan diakui Pemerintah</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Minimal pengalaman selama 3 Tahun dibidangnya</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Usaha yang dimiliki wajib berbadan hukum dan diakui Pemerintah</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <p>Untuk rekening perusahaan wajib terpisah dengan rekening pribadi</p>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut Daftar Pengadaan yang tersedia</p>
        </div>

        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          @foreach($pengadaan as $ada)
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <a href="{{$ada->deskripsi}}" target="_blank">
            <div class="portfolio-img"><img src="{{asset(Storage::url($ada->gambar))}}" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>{{$ada->nama_pengadaan}}</h4>
              <p>Anggaran : Rp. {{number_format($ada->anggaran,0,",",".")}}</p>
            </div>
          </div>
          </a>
          @endforeach
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Silahkan ajukan penawaran Anda sekarang.</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            @if($token == "kosong")
            <a href="/registrasi" class="cta-btn align-middle">Daftar Sekarang</a>
            @else
            <a href="/listSuplier" class="cta-btn align-middle">Ajukan Sekarang</a>
            @endif
          </div>
        </div>
