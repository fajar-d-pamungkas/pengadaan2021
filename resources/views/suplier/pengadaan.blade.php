                ...
                <table style="text-align:center;" class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button data-id_pengadaan="{{$ada->id_pengadaan}}" data-nama_pengadaan="{{$ada->nama_pengadaan}}" data-anggaran="{{$ada->anggaran}}" class="btn btn-success detail" data-toggle="modal" data-target="#pengajuanModal">
