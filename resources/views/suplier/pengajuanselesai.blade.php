                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="post" action="/tambahLaporan" enctype="multipart/form-data">
                          {{csrf_field()}}
                          <input type="hidden" name="id_pengajuan" id="id_pengajuan" value="{{$aju['id_pengajuan']}}">
                          ...
                          <button type="submit" class="btn btn-info"><i class="fas fa-save"></i>Upload Laporan
                          </button>
                        </form>
                        @else
                        <a href="{{asset(Storage::url($aju['laporan']))}}" class="btn btn-warning" target="_blank"><i class="fas fa-eye"></i>Lihat Laporan</a>
                        @endif
                        @endif
                        @if($aju['status_pengajuan'] == 3 )
                        Telah Selesai
                        @endif
                      </td>
                      <td>
