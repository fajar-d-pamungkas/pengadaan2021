                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if($aju['status_pengajuan'] == 2 )
                        <a href="{{asset(Storage::url($aju['laporan']))}}" class="btn btn-info" target="_blank"><i class="fa fa-eye"></i>Lihat Laporan</a>
                        @endif
                      </td>
                      <td>
                        @if($aju['status_pengajuan'] == 2 )
                          ...
                          <hr>
                          <a href="/selesaiPengajuan/{{$aju['id_pengajuan']}}" class="btn btn-success konfirmasi"><i class="fa fa-check"></i>Diterima</a>
                          <a href="/tolakLaporan/{{$aju['id_laporan']}}" class="btn btn-danger konfirmasi"><i class="fa fa-times"></i>Ditolak</a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
